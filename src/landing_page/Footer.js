...
function Footer() {
  return (
    <footer className="border-top" style={{backgroundColor: "#f9f9f9", marginBottom: "0", paddingBottom: "0"}}>
    <div className="container mt-5">
      <div className="row mt-5">
        <div className="col">
          <img src="images/logo.svg" style={{ width: "50%", marginBottom: "15px" }} />
      ...
      <p>
        ...
        <p>Smart Online Dispute Resolution | Grievances
        Redressal Mechanism</p> 
        <p>Investments in securities market are subject to
        ...
        issued by NSDL/CDSL every month.</p>
        <p>"Prevent unauthorised transactions in
